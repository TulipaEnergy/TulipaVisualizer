...
#[tauri::command]
pub fn get_storage_price_resolution(db_path: String, year: u32, resolution: u32, storage_type: String) -> Result<Response, String> {
